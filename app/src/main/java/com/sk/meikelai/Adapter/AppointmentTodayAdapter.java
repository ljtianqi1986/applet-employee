...
public class AppointmentTodayAdapter extends BaseQuickAdapter<AppointmentBean.ReturnDataBean, BaseViewHolder> {

    public AppointmentTodayAdapter(int layoutId, List<AppointmentBean.ReturnDataBean> dateBeen) {
