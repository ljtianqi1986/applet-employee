...
public class ThisMonthAchievementFragment extends BaseFragment implements OnChartValueSelectedListener, HandleDataCallBack {
    ...
    public void initView() {
        ...
        AppApi.getAchievementStatistics(MyUtils.getCode(mContext), "2", this, 0);
