...
public class TodayNetRecepitsFragment extends BaseFragment implements OnChartValueSelectedListener, HandleDataCallBack {
    ...
    public void initView() {
        ...
        AppApi.getCashStatistics(MyUtils.getCode(mContext), "1", this, 0);
