...
import com.sk.meikelai.Adapter.CardOnceAdapter;
...
public class TabOnceCardFragment extends BaseFragment implements KindSelectCallBack, HandleDataCallBack, BaseQuickAdapter
        .RequestLoadMoreListener {
    @BindView(R.id.rc_content)
    RecyclerView mRecyclerView;
    LinearLayoutManager linearLayoutManager;
    CardOnceAdapter mAdapter;
    ...
    public void initView() {
        ...
        AppApi.getOpenCardList(MyUtils.getShopCode(getContext()),"0", mTypeCode, mSearch, page, TabOnceCardFragment.this, StaticCode.TAG);
        ...
        mEtSearch.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP) {
                    ...
                    loadingDialog.show();
                    AppApi.getOpenCardList(MyUtils.getShopCode(getContext()),"0", mTypeCode, mSearch, page, TabOnceCardFragment.this, StaticCode
                            .TAG);
                }
                return false;
            }
        ...
        mAdapter = new CardOnceAdapter(R.layout.item_card, allDataList);
        mAdapter.setOnLoadMoreListener(TabOnceCardFragment.this, mRecyclerView);
