...
public class LastMonthAchievementFragment extends BaseFragment implements OnChartValueSelectedListener, HandleDataCallBack {
    ...
    public void initView() {
        ...
        AppApi.getAchievementStatistics(MyUtils.getCode(mContext), "3", this, 0);
