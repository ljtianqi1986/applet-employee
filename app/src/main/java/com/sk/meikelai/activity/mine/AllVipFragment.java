...
public class AllVipFragment extends BaseFragment implements HandleDataCallBack, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected int getContentView() {
        return R.layout.fragment_all_vip;
    }
...
//设置adapter
    ...
    private void getVipData(String searchName){
        AppApi.getMyVipList(searchName, MyUtils.getCode(mContext),"2",String.valueOf(page),this,0);
    }
