...
public class ThisMonthNetRecepitsFragment extends BaseFragment implements OnChartValueSelectedListener, HandleDataCallBack {
    ...
    public void initView() {
        ...
        AppApi.getCashStatistics(MyUtils.getCode(mContext),"2",this,0);
