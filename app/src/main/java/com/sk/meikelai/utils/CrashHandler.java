...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        ...
        //保存日志文件
        String fielName = saveCrashInfo2File(ex);

        File file = new File("/sdcard/crash/" + fielName);
        upLoadData(file);
        return true;
    }
    ...
    private void upLoadData(File file) {
        RequestParams requestParams = new RequestParams(HttpUtils.TEST_HOST + StaticCode.Upload_Error);
        Log.v("upLoadError", requestParams.toString());
